...
namespace JonathanGranja.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(JonathanGranjaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,nombre_carrera,campus,numero_semestres")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nombre_carrera,campus,numero_semestres")] Carrera carrera)
        {
            if (id != carrera.Id)
            {
                return NotFound();
